...
if(!$studid) {
    die("Error: studid not provided in the URL");
}

$sqlStudent = "SELECT tbstudinfo.lastname, tbstudinfo.firstname, tb_department.department_name, tbstudentaccount.student_email, tbstudentaccount.student_profile
        FROM tbstudinfo
...
$stmtStudent->bind_param("i", $studid);
$stmtStudent->execute();
...
if($stmtStudent->num_rows > 0) {
    $stmtStudent->bind_result($lastname, $firstname, $department_name, $student_email, $student_profile);
    $stmtStudent->fetch();
    $stmtStudent->close();
    ...
    $stmtEventsAttended->bind_param("i", $studid);
        ...
        <section class="profile-sec">
            ...
            if(isset($studid)) {
                ...
                <div class="profile-info">
                    ...
                    if($student_profile) {
                        ?>
                        <img class="profile-image" src="../../<?php echo $student_profile; ?>" alt="Profile Image">
                        <?php
                    } else {
                        ?>
